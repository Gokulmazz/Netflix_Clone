...
const Nav = () => {
    ...
    const [setnavslide, setnav] = useState(false);
    const scrollhand = () => {
    ...
    return (
        <nav style={{
            backgroundColor: setnavslide ? 'rgb(20, 2, 2)' : 'transparent',

        }}
        >
            <section>
                <div className="nav-left">
                    <img className="Netflix-logo" alt="image" src="https://images.ctfassets.net/4cd45et68cgf/7LrExJ6PAj6MSIPkDyCO86/542b1dfabbf3959908f69be546879952/Netflix-Brand-Logo.png?w=684&h=456"></img>
